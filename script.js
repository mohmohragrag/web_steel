...
function showFields() {
    ...
    if (sectionType === "UPN") {
        window.location.href = "web_steel/upn/index.html";
    } else if (sectionType === "IPN") {
        window.location.href = "web_steel/ipn/index.html";
    } else if (sectionType === "IPE") {
        window.location.href = "web_steel/ipe/index.html";
    } else if (sectionType === "HEA") {
        window.location.href = "web_steel/hea/index.html";
    } else if (sectionType === "HEB") {
        window.location.href = "web_steel/heb/index.html";
